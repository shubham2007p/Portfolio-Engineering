        ...
        <div className="mobile-drawer" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="mobile-drawer-footer">
            ...
            <div className="mobile-socials-row">
              ...
              <a href="https://linkedin.com/in/shubh-panwar" target="_blank" rel="noopener noreferrer" className="mobile-social-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              <a href="https://x.com/shubh-panwar" target="_blank" rel="noopener noreferrer" className="mobile-social-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
            ...
            <a href="mailto:shubham.panwar.dev@gmail.com" className="mobile-email-link">
              Email me
            </a>
          </div>
        </div>
